...
function isChangePossible(changeTarget, cid) {
  ...
  reversedArr.forEach((currency) => {
    ...
    const currencyQuantityInString = (currency[1] / singleCurrencyValue).toPrecision(3);
    const currencyQuantity = Number(currencyQuantityInString);
